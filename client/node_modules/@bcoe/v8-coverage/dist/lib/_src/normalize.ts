import { compareFunctionCovs, compareRangeCovs, compareScriptCovs } from "@bcoe/v8-coverage/dist/lib/_src/compare";
import { RangeTree } from "@bcoe/v8-coverage/dist/lib/_src/range-tree";
import { FunctionCov, ProcessCov, ScriptCov } from "@bcoe/v8-coverage/dist/lib/_src/types";
